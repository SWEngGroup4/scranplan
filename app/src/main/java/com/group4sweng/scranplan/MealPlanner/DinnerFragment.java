...
import com.group4sweng.scranplan.SearchFunctions.DinnerQueries;
import com.group4sweng.scranplan.SearchFunctions.DinnerRecyclerAdapter;
...
public class DinnerFragment extends Fragment {
    ...
    List<DinnerRecyclerAdapter.DinnerRecipePreviewData> dataDinner;
    ...
    List<DinnerRecyclerAdapter.DinnerRecipePreviewData> dataFave;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(user != null) {
            ...
            final RecyclerView.Adapter rAdapterDinner = new DinnerRecyclerAdapter(DinnerFragment.this, dataDinner);
            ...
            final RecyclerView.Adapter rAdapterFave = new DinnerRecyclerAdapter(DinnerFragment.this, dataFave);
