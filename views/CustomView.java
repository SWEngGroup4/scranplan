...
import com.example.sweng_graphics.R;
...
public class CustomView extends View
{
    ...
    {
        circle_array[num_circles] = new circle(200, 200, 100); //created a new circle object
    ...
    public void new_square()
    {
        ...
        square_array[num_squares] = new square(100, 100, 200);
        num_squares++;
        start_timer(5000, 1);
    ...
    {
        triangles[num_triangles] = new triangle(200,200,200);
...
public void delete_triangle()
    ...
    {
        lines[num_lines] = new line(x_start, y_start, x_finish, y_finish);
        start_timer(5000, 2);
        num_lines++;
        postInvalidate();
